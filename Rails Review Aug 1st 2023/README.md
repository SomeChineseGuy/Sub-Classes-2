[Code Repo](https://github.com/SomeChineseGuy/WebFlex-Jan-2023/tree/main/M10W24%20Rails%20Review)
...
- learning some new is always awkward and bad at the start
- Syntax changes feel odd
- Ruby on rails has DB built into it
  const pool = new Pool({})
